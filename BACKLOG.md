...
- [ ] Feedback fonema por fonema con score visual (estilo ELSA Speak) — diseño técnico documentado en `planVersion1.md` Fase 9.20 (Fase E del plan de mejora vs. competidores). Requiere alineación fonémica completa (no solo el fonema con acento primario) + un modelo de GOP (Goodness of Pronunciation) + UI de espectrograma — suficientemente grande como para ser su propia iteración, no un add-on de ITER-2.
