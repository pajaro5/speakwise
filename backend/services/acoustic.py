...
from backend.services.phoneme import analyze_phonemes, analyze_phrase_linking, count_words_evaluated
...
async def transcribe_and_analyze(
    ...
    if target_words:
        ...
        stress_results += analyze_phrase_linking(raw.text, target_words)
